...
import ChallengeQuizView from "@/views/ChallengeQuizView.vue";
const routes = [
  ...
  { path: '/challenge/create', name: 'ChallengeCreate', component: ChallengeCreateView, meta: { requiresAuth: true } },
  { path: '/quiz/:challengeId', name: 'QuizView', component: ChallengeQuizView, meta: { requiresAuth: true }, props: true },
]
